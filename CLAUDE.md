...
- Custom node packs baked at build (krea2edit, MAINodes, Spectrum, WhatDreamsCost, H3 Prompt IDE) are pinned by commit + sha256 and listed in `tests/test_template.py BAKED_NODE_PACKS`; a pack with no license stays out (the H3 latent upscaler).
